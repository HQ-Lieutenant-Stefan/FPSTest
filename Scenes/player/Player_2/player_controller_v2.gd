...
@onready var weapon = $neck/head/eyes/First_view/WeaponRIG/Weapon
@export var Weapon_Controler: WeaponController
...
func _physics_process(delta):
	...
	Global.debug.add_property("Weapon name", weapon.current_weapon_name, 2)
